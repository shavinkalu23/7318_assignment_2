# -*- coding: utf-8 -*-
"""7318_assignment2.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1R6kbyiVRJGhzfie2oVQ5JOp46hk3KV_X
"""
...
torch.save(model, 'models/vgg16.pth')
...
torch.save(model, 'models/resnet34.pth')
...
vgg_3_metrics = compile(model =model, train_data=train_loader,validation_data=val_loader,epochs=EPOCHS,loss_function=loss,optimizer=optimizer,learning_rate_scheduler=lr_s)
...
metrics = pd.DataFrame(vgg_2_metrics)
metrics.to_csv('vgg_2_metrics.csv',index = False)

metrics = pd.DataFrame(base_cnn_metrics)
metrics.to_csv('base_cnn_metrics.csv',index = False)

metrics = pd.DataFrame(vgg16_1_metrics)
metrics.to_csv('vgg16_1_metrics.csv',index = False)

metrics = pd.DataFrame(resnet_metrics)
metrics.to_csv('resnet_metrics.csv',index = False)